...
variable "allowed_cidrs" {
  description = "List of allowed CIDR ranges to access the Azure Static Web Apps resource."
  type        = list(string)
  default     = []
}

variable "allowed_subnet_ids" {
  description = "List of allowed subnets IDs to access the Azure Static Web Apps resource."
  type        = list(string)
  default     = []
}
